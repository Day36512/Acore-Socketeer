--by Dinkledork
-- This script creates an NPC that allows you to exchange Frozen Orbs for a socket enchant you can use on any piece of equipment
--Just .npc add 190015

local SocketEnchant = 37430 -- Socket Enchant Item ID
local RequiredItem = 43102 -- Frozen Orb ID. Can set this to whatever Item ID.
...
player:SendBroadcastMessage("Exchanging " .. requiredAmount .. " Frozen Orb for a socket enchant. Are you sure?")
...
WorldDBQuery("DELETE FROM `creature_template` WHERE `entry`=190015;")
